...
@section('datagame')
    ...
    <input type="text" id="inputfield2" class="form-control d-none" name="server" placeholder="Server ID">
    <br>
    ...
    <button type="button" class="btn btn-primary" onclick="CheckUsername('EIGHT_BALL_POOL')">Cek username</button>
@endsection
@section('items')
              ...
              <div class="card-body" style="padding: 0.5rem;position:relative;">
                <div class="card-items">
                  <center><div class="img-item">
                    <img class="img-fluid rounded" src="{{ asset('storage/static/assets/8ballpool coin.webp') }}" >
                  </div></center>
                  <div>
