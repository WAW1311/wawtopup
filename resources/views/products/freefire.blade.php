...
@section('datagame')
            ...
            <button type="button" class="btn btn-primary" onclick="CheckUsername('FREEFIRE')">Cek username</button>
@endsection
@section('items')
                      ...
                      <div class="card-body" style="padding: 0.5rem;position:relative;">
                        <div class="card-items">
                          <center><div class="img-item">
                            <img class="img-fluid rounded" src="{{ asset('storage/static/assets/diamond.webp') }}" >
                          </div></center>
                          <div>
