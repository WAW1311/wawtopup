...
@section('howto')
<p>Cara Topup Arena of Valor<br>
...
@section('datagame')
            ...
            <button type="button" class="btn btn-primary" onclick="CheckUsername('AOV')">Cek username</button>
@endsection
@section('items')
              ...
              <div class="card-body" style="padding: 0.5rem;position:relative;">
                <div class="card-items">
                  <center><div class="img-item">
                    <img class="img-fluid rounded" src="{{ asset('storage/static/assets/Aov1.webp') }}" >
                  </div></center>
                  <div>
